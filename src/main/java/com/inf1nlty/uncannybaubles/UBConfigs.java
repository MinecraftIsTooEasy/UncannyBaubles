...
public class UBConfigs extends SimpleConfigs {
    ...
    public static final ConfigDouble ancientBoneLordNecklaceDropProbability = new ConfigDouble(
        "uncannybaubles.ancientBoneLordNecklaceDropProbability", 0.05, 0.0, 1.0,
